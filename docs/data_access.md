...
The primary analysis uses the corrected Codebook v2 MAGIX files and the
...
This primary universe estimates the incremental CAP grammar association among
loci with supported intrinsic GHT binding; it does not represent
GHT-negative/ChIP-positive loci.
