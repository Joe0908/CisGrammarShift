# Toronto-GPZN processing sensitivity

This directory documents the no-retuning processing-pipeline sensitivity based
on the public Toronto-GPZN tracks. The author-supplied McGill-GPHN panel remains
the primary outcome source.

## Assets

The sensitivity does **not** generate 12 bigWigs from the 175.39-GB merged Codebook archive. It resolves and
...
- `reports/capselex_primary_genomic_model_screening.json` is the GPZN model report.
